...
class DemoApplicationTests {
	...
	void fireStationTest() throws IOException {	
		...
		firestation.setAddress("16");
		firestationService.updateFirestation(firestation);
		firestationService.deleteFirestation(firestation);
	}
	
	@Test
	void firestationGetByStationNumberTest() throws JsonParseException, JsonMappingException, IOException{
		ObjectMapper objectMappper = new ObjectMapper();
	...
	@Test
	void getStationNumberFromAddress() throws JsonParseException, JsonMappingException, IOException {
	...
	void fireTest() throws JsonParseException, JsonMappingException, IOException {
		...
		List<Map<String,Object>> retour = personService.getListPersonByAddressWithMedicalRecord("1509 Culver St");
		assertTrue(retour.size()==5);
	}
	...
	void floodTest() throws JsonParseException, JsonMappingException, IOException {
		...
		entre.add("1");
		Map<String, Object> retour = personService.getListOfPeopleSortedByAddressCoveredByThoseStations(entre);
	...
	void getPersonalInfoTest() throws JsonParseException, JsonMappingException, IOException {
		...
		List<Map<String,Object>> retour = personService.getPersonnalInformationOfPeople("John", "Boyd");
