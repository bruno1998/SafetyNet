...
public class MedicalRecordRepository extends JsonReader {
	...
	public List<MedicalRecord> getAllMedicalRecord() throws IOException {
		return (List<MedicalRecord>) readJsonData(new TypeReference<List<MedicalRecord>>() {},
				nodeName);
	}


	public MedicalRecord getListFirstNameAndLastName(String firstName, String lastName)
			throws IOException {
		MedicalRecord medicalRecords = this.getAllMedicalRecord().stream()
